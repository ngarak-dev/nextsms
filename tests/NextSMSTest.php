...
use Mockery;
use NgarakDev\NextSMS\Exceptions\InvalidPayload;
...
class NextSMSTest extends TestCase
{
    ...
    public function it_can_send_single_sms_to_single_destination()
    {
        ...
        $response = NextSMS::sendSingleSMS(['to' => '255768491010', 'text' => 'Helooo NextSMS.']);
    ...
    public function it_can_throw_exception_when_payload_of_single_destination_is_invalid()
    {
        ...
        $response = NextSMS::sendSingleSMS(['to' => '255768491010']);
    }
    ...
    public function it_can_recharge_sub_customer()
    {
        ...
        $response = NextSMS::subCustomerRecharge('ngarakiringo@gmail.com', 100);
    ...
    public function it_can_deduct_sub_customer()
    {
        ...
        $response = NextSMS::subCustomerDeduct('ngarakiringo@gmail.com', 100);
